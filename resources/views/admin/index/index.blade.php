    ...
    <div class="row top_tiles">
        ...
        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="tile-stats">
                ...
                <div class="count">{{ $socialiteUserCount ?? 0 }}</div>
        ...
        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="tile-stats">
                ...
                <div class="count">{{ $articleCount ?? 0 }}</div>
                    ...
                    <ul class="list-inline widget_tally">
                        <li>
                            <p>
                                ...
                                <span class="count">{{ config('bjyblog.version') }} <a href="{{ url('admin/upgrade') }}"
